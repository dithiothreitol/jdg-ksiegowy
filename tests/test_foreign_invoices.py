...
from jdg_ksiegowy.invoice.generator_xml import FA3_NS, generate_invoice_xml
...
class TestForeignInvoiceXML:
    ...
    def test_np_vat_code_in_p12(self):
        ...
        buyer = Buyer(
            name="DE GmbH", nip="", country_code="DE", eu_vat_number="DE123456789", address="Berlin"
        )
        item = LineItem(
            description="Usługa",
            unit_price_net=Decimal("1000"),
